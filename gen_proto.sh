...
rm -f csharp.proto
cat csharp.header > csharp.proto
tail -n +2 src/main/resources/protobuf/message.proto >> csharp.proto
#"D:/work/protobuf/bin/protoc" -I=. --csharp_out=D:/../../godot/y1000/Source/Networking/Protobuf message.proto
"D:/work/protobuf/bin/protoc" -I=. --csharp_out=D:/godot_qn/qn_client/code/network csharp.proto
