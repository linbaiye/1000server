...
class MoverTest {
    ...
    void setUp() {
        ...
        when(npc.oldStateEnum()).thenAnswer(invocationOnMock -> playerStateEnum);
        doAnswer(invocationOnMock -> {
            playerStateEnum = OldPlayerStateEnum.Move;
    ...
    void walk() {
        ...
        when(npc.getStateMillis(OldPlayerStateEnum.IDLE)).thenReturn(0);
    ...
    void walkSpeed() {
        ...
        when(npc.getStateMillis(OldPlayerStateEnum.IDLE)).thenReturn(100);
        when(npc.getStateMillis(OldPlayerStateEnum.Move)).thenReturn(100);
