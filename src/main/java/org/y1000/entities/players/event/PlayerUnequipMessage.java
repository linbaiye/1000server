...
public final class PlayerUnequipMessage extends AbstractInsightPlayerMessage {


    public PlayerUnequipMessage(Player source,
                                Packet packet) {
        super(source, packet);
    }


    public static PlayerUnequipMessage of(Player player, EquipmentType type) {
        ...
        Packet packet = Packet.newBuilder()
                .setUnequip(builder)
                .build();
        return new PlayerUnequipMessage(player, packet);
    }
