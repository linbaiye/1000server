...
public final class OldPlayerAttackEvent extends IAbstractPlayerEvent
    ...
    public OldPlayerAttackEvent(Player source, OldPlayerStateEnum attackPlayerStateEnum, Integer effectId) {
        super(source);
        this.attackPlayerStateEnum = attackPlayerStateEnum;
        this.effectId = effectId;
    }
    public OldPlayerAttackEvent(Player source, OldPlayerStateEnum attackPlayerStateEnum) {
        this(source, attackPlayerStateEnum, null);
    }

    public static OldPlayerAttackEvent of(Player player, Integer effectId) {
        return null;
