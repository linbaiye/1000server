...
public final class Guardian extends AbstractViolentNpc implements HumanNpc {
    ...
    @Builder
    public Guardian(long id, Coordinate coordinate, Direction direction, String name, Map<NpcAnimationEnum, Integer> stateMillis, AttributeProvider attributeProvider, RealmMap realmMap, INpcAI ai, int width) {
