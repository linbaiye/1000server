...
public enum Direction {
    ...
    UP(new Coordinate(0, -1), 0, -1, 0),
    UP_RIGHT(new Coordinate(1, -1), 1, -1, 1),


    RIGHT(new Coordinate(1, 0), 2, 0, 1),

    DOWN_RIGHT(new Coordinate(1, 1), 3, 1, 1),

    DOWN(new Coordinate(0, 1), 4, 1, 0),

    DOWN_LEFT(new Coordinate(-1, 1), 5, 1, -1),

    LEFT(new Coordinate(-1, 0), 6, 0, -1),
