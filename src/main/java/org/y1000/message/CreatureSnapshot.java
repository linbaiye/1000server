...
public final class CreatureSnapshot extends AbstractNamedCreatureSnapshot {
    ...
    public CreatureSnapshot(long id, Coordinate coordinate, OldPlayerStateEnum playerStateEnum,
    ...
    public CreatureSnapshot(long id, Coordinate coordinate, int stateValue,
                            Direction direction, int elapsedMillis, String name, NpcType type,
                            String animate, String shape) {
